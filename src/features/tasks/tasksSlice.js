...
const initialState = {
  tasks: [
    { id: 1, title: 'Belajar react', description: 'components and hooks', priority: 'High', status: 'To-Do' },
    { id: 2, title: 'Belajar redux', description: 'state management with Redux', priority: 'Medium', status: 'In Progress' },
  ],
};
